...
func main(){
	...
	// Vamos gerar uma rotina que vai falhar nossa reserva por tempo excedido
	go func(){
		// Vamos dar só 3 segundos de espera para essa rotina
		time.Sleep(time.Second * 3)
		// Vamos exibir na tela que rotina estamos
		println("Rotina de 3 segundos")
		cancel() // Cancelando o contexto para interromper as operações do goroutine
	}()
